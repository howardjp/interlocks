...
Associated and family relationships now extend the typed conflict facts through owner declarations and consent-bound one-hop account links without adding executable policy-pack code. The next substantive phase is structured synthetic-user and lawyer validation of the installed conflict-clearance packs.
