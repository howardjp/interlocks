...
export class SqliteInterlocksRepository extends InterlocksRepository {
  ...
  normalizePolicyQuestions(input = {}) {
    ...
    return raw.map((question, index) => {
      ...
      return { key, text: required(question.text || question.question, "Policy question"), context: isObject(question.context) ? structuredClone(question.context) : {}, authorities: [...selected.values()] };
    });
  }
