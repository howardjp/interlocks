const RESOURCE_TYPES = [
  ...
  "CONSENT", "SCREEN", "CONTROL", "ASSOCIATED_PERSON_REQUEST", "IMPORT_BATCH", "ADMINISTRATIVE_ACTION",
];
...
export const SQLITE_MIGRATIONS = [
  ...
  },
  {
    ...
    up(db) {
      db.exec(`CREATE VIRTUAL TABLE entity_search USING fts5(entity_id UNINDEXED, canonical_name, aliases, content='');`);
    },
  },
  {
    version: 3,
    ...
    up(db) {
      db.exec("DROP TABLE entity_search; CREATE VIRTUAL TABLE entity_search USING fts5(entity_id UNINDEXED, canonical_name, aliases);");
    },
  },
  {
    version: 4,
